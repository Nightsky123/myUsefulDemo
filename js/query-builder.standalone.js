...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        define('jQuery.extendext', ['js/jquery'], factory);
    }
...
(function(root, factory) {
    if (typeof define == 'function' && define.amd) {
        define('query-builder', ['js/jquery', 'dot/doT', 'jquery-extendext'], factory);
    }
    else if (typeof module === 'object' && module.exports) {
        module.exports = factory(require('js/jquery'), require('dot/doT'), require('jquery-extendext'));
    }
    else {
